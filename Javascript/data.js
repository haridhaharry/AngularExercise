...
//literals - for boolean we true , false for false 
//literals - for string we can either enclose the string with single or double quote
//variables that are declared in a js file direclty not part of function is
  //consider global, it will be available through out the file


a=90 // no data type specification a is variable 90 is numeric literal
b=falsec="ram"
c=90
d=90.43
